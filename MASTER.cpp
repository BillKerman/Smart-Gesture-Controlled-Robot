...
// - I2Cdev: For I2C communication, make sure I2Cdev and MPU6050 libraries are installed
...
void setup() {
  ...
  BTSerial.begin(38400); // Initialize serial communication with HC-05 module
